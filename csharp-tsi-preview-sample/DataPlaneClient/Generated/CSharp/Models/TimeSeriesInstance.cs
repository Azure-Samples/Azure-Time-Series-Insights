...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    public partial class TimeSeriesInstance
    {
        ...
        /// environment. Immmutable, never null.</param>
        ...
        public TimeSeriesInstance(IList<object> timeSeriesId, System.Guid typeId, string name = default(string), string description = default(string), IList<System.Guid?> hierarchyIds = default(IList<System.Guid?>), IDictionary<string, object> instanceFields = default(IDictionary<string, object>))
        {
        ...
        /// It matches Time Series ID properties in an environment. Immmutable,
        /// never null.
        /// </summary>
