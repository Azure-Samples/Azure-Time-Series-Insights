...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// </summary>
    public partial class TimeSeriesInstancesGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TimeSeriesInstancesGetHeaders
        /// class.
        /// </summary>
        public TimeSeriesInstancesGetHeaders()
        {
            CustomInit();
        }
        ...
        public TimeSeriesInstancesGetHeaders(string serverRequestId = default(string))
        {
