...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// <summary>
    /// Defines headers for GetTypesPaged operation.
    /// </summary>
    public partial class GetTypesPagedHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetTypesPagedHeaders class.
        /// </summary>
        public GetTypesPagedHeaders()
        {
            CustomInit();
        }
        ...
        public GetTypesPagedHeaders(string serverRequestId = default(string))
        {
