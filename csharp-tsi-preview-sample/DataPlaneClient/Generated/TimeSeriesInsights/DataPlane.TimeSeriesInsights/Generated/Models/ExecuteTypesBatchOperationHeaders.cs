...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// <summary>
    /// Defines headers for ExecuteTypesBatchOperation operation.
    /// </summary>
    public partial class ExecuteTypesBatchOperationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ExecuteTypesBatchOperationHeaders
        /// class.
        /// </summary>
        public ExecuteTypesBatchOperationHeaders()
        {
            CustomInit();
        }
        ...
        public ExecuteTypesBatchOperationHeaders(string serverRequestId = default(string))
        {
