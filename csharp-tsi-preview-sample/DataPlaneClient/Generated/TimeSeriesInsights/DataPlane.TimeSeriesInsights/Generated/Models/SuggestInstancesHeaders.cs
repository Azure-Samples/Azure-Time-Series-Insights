...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// <summary>
    /// Defines headers for SuggestInstances operation.
    /// </summary>
    public partial class SuggestInstancesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SuggestInstancesHeaders class.
        /// </summary>
        public SuggestInstancesHeaders()
        {
            CustomInit();
        }
        ...
        public SuggestInstancesHeaders(string serverRequestId = default(string))
        {
