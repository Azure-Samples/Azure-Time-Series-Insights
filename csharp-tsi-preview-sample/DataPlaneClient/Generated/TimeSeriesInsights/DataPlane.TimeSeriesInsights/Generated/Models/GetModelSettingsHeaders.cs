...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// <summary>
    /// Defines headers for GetModelSettings operation.
    /// </summary>
    public partial class GetModelSettingsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetModelSettingsHeaders class.
        /// </summary>
        public GetModelSettingsHeaders()
        {
            CustomInit();
        }
        ...
        public GetModelSettingsHeaders(string serverRequestId = default(string))
        {
