...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// </summary>
    public partial class GetEventSchemaHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetEventSchemaHeaders class.
        /// </summary>
        public GetEventSchemaHeaders()
        {
            CustomInit();
        }
        ...
        public GetEventSchemaHeaders(string serverRequestId = default(string))
        {
