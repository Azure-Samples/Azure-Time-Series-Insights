...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// <summary>
    /// Defines headers for SearchInstancesPaged operation.
    /// </summary>
    public partial class SearchInstancesPagedHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SearchInstancesPagedHeaders
        /// class.
        /// </summary>
        public SearchInstancesPagedHeaders()
        {
            CustomInit();
        }
        ...
        public SearchInstancesPagedHeaders(string serverRequestId = default(string))
        {
