...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    public partial class TimeSeriesModelSettings
    {
        ...
        public TimeSeriesModelSettings(string name = default(string), IList<TimeSeriesIdProperty> timeSeriesIdProperties = default(IList<TimeSeriesIdProperty>), System.Guid? defaultTypeId = default(System.Guid?))
        {
            Name = name;
        ...
        public System.Guid? DefaultTypeId { get; private set; }
