...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// </summary>
    public partial class TimeSeriesHierarchiesGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TimeSeriesHierarchiesGetHeaders
        /// class.
        /// </summary>
        public TimeSeriesHierarchiesGetHeaders()
        {
            CustomInit();
        }
        ...
        public TimeSeriesHierarchiesGetHeaders(string serverRequestId = default(string))
        {
