...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// <summary>
    /// Defines headers for GetInstancesPaged operation.
    /// </summary>
    public partial class GetInstancesPagedHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetInstancesPagedHeaders class.
        /// </summary>
        public GetInstancesPagedHeaders()
        {
            CustomInit();
        }
        ...
        public GetInstancesPagedHeaders(string serverRequestId = default(string))
        {
