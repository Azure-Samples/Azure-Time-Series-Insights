...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    public partial class ModelSettings
    {
        ...
        public ModelSettings(string name = default(string), IList<TimeSeriesIdProperty> timeSeriesIdProperties = default(IList<TimeSeriesIdProperty>), System.Guid? defaultTypeId = default(System.Guid?))
        {
            Name = name;
