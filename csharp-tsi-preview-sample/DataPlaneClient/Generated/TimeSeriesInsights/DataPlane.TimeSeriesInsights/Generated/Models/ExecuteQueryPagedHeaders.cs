...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// <summary>
    /// Defines headers for ExecuteQueryPaged operation.
    /// </summary>
    public partial class ExecuteQueryPagedHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ExecuteQueryPagedHeaders class.
        /// </summary>
        public ExecuteQueryPagedHeaders()
        {
            CustomInit();
        }
        ...
        public ExecuteQueryPagedHeaders(string serverRequestId = default(string))
        {
