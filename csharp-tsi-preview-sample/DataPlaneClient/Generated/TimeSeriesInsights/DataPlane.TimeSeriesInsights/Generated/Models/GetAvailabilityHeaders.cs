...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// </summary>
    public partial class GetAvailabilityHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetAvailabilityHeaders class.
        /// </summary>
        public GetAvailabilityHeaders()
        {
            CustomInit();
        }
        ...
        public GetAvailabilityHeaders(string serverRequestId = default(string))
        {
