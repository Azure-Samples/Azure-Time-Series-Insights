...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateModelSettings operation.
    /// </summary>
    public partial class UpdateModelSettingsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateModelSettingsHeaders class.
        /// </summary>
        public UpdateModelSettingsHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateModelSettingsHeaders(string serverRequestId = default(string))
        {
