...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    public partial class TimeSeriesHierarchy
    {
        ...
        /// <summary>
        /// Gets or sets unique hierarchy identifier that is a immutable GUID.
        /// Can be null while creating hierarchy objects and then server
        /// generates the id, not null on get and delete operations.
        /// </summary>
