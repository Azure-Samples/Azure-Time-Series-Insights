...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// <summary>
    /// Defines headers for GetHierarchiesPaged operation.
    /// </summary>
    public partial class GetHierarchiesPagedHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetHierarchiesPagedHeaders class.
        /// </summary>
        public GetHierarchiesPagedHeaders()
        {
            CustomInit();
        }
        ...
        public GetHierarchiesPagedHeaders(string serverRequestId = default(string))
        {
