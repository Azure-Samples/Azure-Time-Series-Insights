...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// </summary>
    public partial class TimeSeriesTypesGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TimeSeriesTypesGetHeaders class.
        /// </summary>
        public TimeSeriesTypesGetHeaders()
        {
            CustomInit();
        }
        ...
        public TimeSeriesTypesGetHeaders(string serverRequestId = default(string))
        {
